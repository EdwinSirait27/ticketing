...
<head>
    ...
    <!-- Fallback CSS jika Tailwind belum loaded -->
    <style>
        html, body {
...
<body class="bg-slate-950 text-gray-100 transition-colors duration-300">
    ...
    <div class="lg:pl-72">
        <div class="max-w-md lg:max-w-none mx-auto min-h-screen bg-slate-900 lg:bg-slate-950 shadow-2xl lg:shadow-none transition-colors duration-300">
            <header class="sticky top-0 z-40 bg-slate-900 lg:backdrop-blur-sm lg:bg-slate-900/80 border-b border-slate-800 transition-colors duration-300">
                <div class="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3 lg:space-x-4">
                            <div class="hidden lg:block h-10 w-1 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full">
                            </div>
    ...
    <div class="hidden lg:block fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-900/10 rounded-full filter blur-3xl transition-colors">
        </div>
        <div class="absolute bottom-0 left-72 w-[600px] h-[600px] bg-cyan-900/10 rounded-full filter blur-3xl transition-colors">
        </div>
    </div>
