            ...
            <div class="px-4 py-4 md:px-6 md:py-5 border-b border-slate-200 dark:border-slate-700">
                <div class="flex flex-col gap-3 md:gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 md:gap-3">
                        ...
                        {{-- Add User Button --}}
                        {{-- <button class="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg font-semibold shadow-md shadow-blue-500/30 hover:shadow-lg hover:shadow-blue-500/40 transition-all text-sm whitespace-nowrap">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        Add User
                            ...
                            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700" id="users-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left hidden md:table-cell">Employee Name</th>
                                        <th class="text-left hidden md:table-cell">Comapany</th>
                                        <th class="text-left hidden md:table-cell">Department</th>
                                        <th class="text-left hidden md:table-cell">Location</th>
                                        <th class="text-left hidden md:table-cell">Position</th>
